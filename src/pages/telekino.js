...
const LoadableTelekinoDesc= Loadable({
  loader: () => import('../components/home/TelekinoDesc'),
  loading: () => <LoaderPlaceholder/>,
});
...
function App() {
  ...
  return (
    <LoadableLayout title={"Telekino | Resultados de Telekino - al instante"}>
    <div className={classes.maincontainer}>
      <LoadableHeader />  
      <Container className={classes.container}>
        <Paper className={classes.root}>
          <LoadableTelekinoDesc />
          <LoadableRemind />
        </Paper>
      </Container>
      <LoadableFooter />
