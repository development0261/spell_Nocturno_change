...
const LoadableQuinielaPlusDesc= Loadable({
  loader: () => import('../components/home/QuinielaPlusDesc'),
  loading: () => <LoaderPlaceholder/>,
});
...
function App() {
  ...
  return (
    <LoadableLayout title={"Quiniela Plus | Resultados de Quiniela Plus - al instante"}>
    <div className={classes.maincontainer}>
      <LoadableHeader />  
      <Container className={classes.container}>
        <Paper className={classes.root}>
          <LoadableQuinielaPlusDesc />
          <LoadableRemind />
        </Paper>
      </Container>
      <LoadableFooter />
